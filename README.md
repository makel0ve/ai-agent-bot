...
| Модуль | Тесты |
|--------|-------|
| `tools/registry` | регистрация, поиск, перезапись |
| `tools/web_search` | успешный ответ, пустой результат, ошибка сети, обрезка текста |
| `tools/weather` | текущая погода, прогноз, HTTP 404/401/429 |
| `tools/currency` | конвертация, дефолтные валюты, ошибка сети |
| `tools/notes` | создание, список, пустой список, удаление |
| `agent/loop` | текстовый ответ, вызов инструмента, неизвестный инструмент, лимит шагов, сохранение в БД |
